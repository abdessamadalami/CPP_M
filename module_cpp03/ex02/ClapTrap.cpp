...
/*   Updated: 2022/11/14 15:57:00 by ael-oual         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name):name(name),Hit_points(10),Energy_point(10),Attack_damage(0) //constructor  use insishialize list here to inishialize the atrributs of this class
{
...
ClapTrap& ClapTrap:: operator =(const ClapTrap& t) // assignement operator  we return pointer to this object for support chining 
{
...
void ClapTrap::takeDamage(unsigned int amount)
{
   ...
   {
        std::cout << "ClapTrap: " << name << amount  << amount << std:: endl;
         Hit_points = 0;
   }
    else
    {
...
ClapTrap::~ClapTrap()
{
    std::cout << "ClapTrap: destructor  ClapTrap" << std:: endl;
}